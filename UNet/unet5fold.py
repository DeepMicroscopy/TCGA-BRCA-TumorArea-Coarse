...
logging.basicConfig(
    filename='unet_5fold.log',
    level=logging.INFO,
    format='%(asctime)s %(message)s'
)

# Initialize Weights and Biases
wandb.init(project="unet-tumor-segmentation-5fold", config={
    "learning_rate": 1e-4,
...
IMAGES_DIR = "/data/Experiments/BRCA_16X/Unet_Final_BVM/Dataset_tiledtiff/Images_tiledtiff"
MASKS_DIR = "/data/Experiments/BRCA_16X/Unet_Final_BVM/Dataset_tiledtiff/Masks_tiledtiff"
CHECKPOINT_DIR = "checkpoints_unet_5fold"
